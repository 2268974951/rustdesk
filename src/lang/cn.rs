...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "欢迎使用~"),
        ("desk_tip", "游客暂不开放登录功能！如需使用请联系微信：Yii_0223"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ...
        ("Website", "网站"),
        ("About", "关于"),
        ("Slogan_tip", "欢迎使用定制版RustDesk。承诺：安全！免费！开源！"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "当前程序未安装，作为被控端，会在某些情况下无法控制鼠标键盘，推荐安装后再使用，您可以点击下面的按钮将 RustDesk 安装到系统。"),
        ...
        ("setup_server_tip", "欢迎~您当前使用的是Yi-Desk自建服务器！"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "注意：如果你和不认识的人连接，而对方要求你使用 RustDesk 启动服务，请勿继续操作。"),
        ("scam_text2", "他们很可能是骗子，试图控制您的设备或窃取您的钱财。"),
